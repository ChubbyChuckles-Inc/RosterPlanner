...
hashes = {}
# Empty state example
hashes["empty_state_no_division_rows"] = capture_case(
    "empty_state_no_division_rows", lambda: EmptyStateWidget("no_division_rows"), (320, 140)
)
# Division table (empty)
hashes["division_table_empty"] = capture_case(
    "division_table_empty", lambda: DivisionTableView(), (640, 260)
)
